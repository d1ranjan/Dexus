...
import { authIdentities, brainDumps, documents, followups, goals, knowledge, notes, people, profiles, tasks, timelineEvents, type InsertUser, type User, users } from "../drizzle/schema";
